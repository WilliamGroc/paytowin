...
import 'package:paytowin/app/modules/boardGame/binding.dart';
import 'package:paytowin/app/modules/boardGame/board.dart';

import 'package:paytowin/app/modules/cardDetail/binding.dart';
import 'package:paytowin/app/modules/cardDetail/cardDetail.dart';

import 'package:paytowin/app/modules/cardList/binding.dart';
import 'package:paytowin/app/modules/cardList/cardList.dart';

import 'package:paytowin/app/modules/home/home.dart';
...
var pages = [
  ...
  GetPage(name: Routes.BOARD_GAME, page: () => const BoardGamePage(), binding: BoardGameBinding(cardRepository))
];
